...
import { Reporte04milagrosComponent } from './reportes/reporte04milagros/reporte04milagros.component';
...
const routes: Routes = [
  ...
  {
    path: 'tipodemuebles',
    component: TipomueblesComponent
  },
  {
    path: 'reporte1',
  ...
  {
    path: 'reporte04milagros',
    component: Reporte04milagrosComponent
  }
